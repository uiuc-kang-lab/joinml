...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           ...
           'wide_resnet50_2', 'wide_resnet101_2', 'model_dict']
...
def resnext152_32x4d(pretrained=False, progress=True, **kwargs):
    r"""ResNeXt-152 32x4d model from
    `"Aggregated Residual Transformation for Deep Neural Networks" <https://arxiv.org/pdf/1611.05431.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
...
def resnext152_32x8d(pretrained=False, progress=True, **kwargs):
    r"""ResNeXt-152 32x8d model from
    `"Aggregated Residual Transformation for Deep Neural Networks" <https://arxiv.org/pdf/1611.05431.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
...
def resnext152_64x4d(pretrained=False, progress=True, **kwargs):
    r"""ResNeXt-152 64x4d model from
    `"Aggregated Residual Transformation for Deep Neural Networks" <https://arxiv.org/pdf/1611.05431.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
...
model_dict = {
    ...
    'resnext101v1': resnext101_32x4d,
    'resnext101v2': resnext101_32x8d,
    'resnext101v3': resnext101_64x4d,
    'resnext152v1': resnext152_32x4d,
    'resnext152v2': resnext152_32x8d,
