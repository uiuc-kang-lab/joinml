...
from joinml.executable.joinml_ci import run as run_blocking_sampling
...
from joinml.executable.joinml import run as run_joinml
...
def run(config: Config):
    ...
    elif config.task in ["joinml-ci", "joinml-mse"]:
        run_joinml(config)
    else:
